...
function Cf(e, t, n) {
  ...
  return { $$typeof: hi, type: e, key: o, ref: s, props: i, _owner: cu.current }
}
function Qh(e, t) {
  return {
    $$typeof: hi,
...
function Pf(e, t, n) {
  ...
  return { $$typeof: Jh, type: e, key: o, ref: s, props: i, _owner: e0.current }
}
Ho.Fragment = Xh
Ho.jsx = Pf
Ho.jsxs = Pf
...
;(function (e) {
  ...
  function p(M) {
    for (var U = n(a); U !== null; ) {
      ...
      else if (U.startTime <= M) r(a), (U.sortIndex = U.expirationTime), t(u, U)
      else break
      U = n(a)
    }
  }
...
function pr(e, t) {
  e.blockedOn === t &&
    ((e.blockedOn = null),
    gl ||
      ((gl = !0), $e.unstable_scheduleCallback($e.unstable_NormalPriority, R0)))
}
function Qr(e) {
  function t(i) {
    return pr(i, e)
...
function am(e) {
  if (e === "selectionchange" || e === "keyup" || e === "keydown") return Qo(Kr)
}
function cm(e, t) {
  ...
  if (
    ...
    if (n._owner) {
      ...
      return t !== null &&
        ...
        : ((t = function (s) {
            var l = i.refs
            l === Md && (l = i.refs = {}), s === null ? delete l[o] : (l[o] = s)
          }),
          (t._stringRef = o),
          t)
    }
...
function zd(e) {
  ...
  function h(d, c, p) {
    ...
    if (typeof c == "object" && c !== null) {
      ...
      if (_r(c) || cr(c)) return (c = wn(c, d.mode, p, null)), (c.return = d), c
      Ui(d, c)
    }
    return null
  }
      ...
      if (!r.hasOwnProperty(a) && i.hasOwnProperty(a) && i[a] != null)
        if (a === "style") {
          ...
          a !== "dangerouslySetInnerHTML" &&
            ...
            a !== "autoFocus" &&
            (Br.hasOwnProperty(a) ? o || (o = []) : (o = o || []).push(a, null))
    for (a in r) {
      var u = r[a]
      if (
        ((l = i != null ? i[a] : void 0),
  ...
  if (((r = e), typeof e == "function")) Ju(e) && (s = 1)
    ...
    e: switch (e) {
      ...
      case mu:
        ...
        break
      case nl:
        return (e = Ge(12, n, t, i | 2)), (e.elementType = nl), (e.lanes = o), e
      case rl:
...
const ay = "/assets/gallery_DnD-8a790a94.webp.png",
  cy = "/assets/moviebox-e580f9df.webp.webp",
  fy = "/assets/todo-7427ff3e.webp.png",
  dy = "/assets/timer-df4d3c49.webp.png",
  ...
  gy = [
    ...
    {
      id: 3,
      title: "Electrical Electronics Enginnerring",
      duration: "2019 - 2021",
      school: "Auchi Polytechnic Institute",
    },
  ],
  wy = [
    { id: 1, position: "Web Developer", duration: "2021-2023", company: "personal projects - While I may not have formal work experience, I have developed and refined my coding skills through personal projects and self-study." }
  ],
  Mc = [
    {
      id: 1,
      name: "PanFlix",
      src: cy,
      link: "https://panflix-5fba4.web.app/",
      description:
        "PanFlix is a movie reviews, streaming and download website where users can stream movies and their details and also download. ",
    },
    {
      id: 2,
      name: "Okay-Mart",
      src: ay,
      link: "https://okaymart-8c627.web.app/",
      description:
        "Okay-Mart is an ecommerce website where buyers can buy goods at the confort of their palm",
    },
    {
      id: 3,
      name: "Portfolio v1",
      src: fy,
      link: "https://okayinterrupt.web.app/",
      description:
        "okayinterrupt is my first ever responsive and animated Portfolio website integrated with email message channel",
    },
    {
      id: 4,
      name: "Panda Hub",
      src: dy,
      link: "https://pandahubtest.web.app/",
      description:
        "Panda Hub is my first ever frontend blogging website using bootstrap and owl carousel.",
    },
  ],
  Sy = [
    { id: 0, src: py, test: "Nigeria" },
    {
      id: 2,
      src: hy,
      link: "https://github.com/emmzyrayz",
      text: "Emmzyrayz",
    },
    {
      id: 3,
      src: my,
      link: "https://www.linkedin.com/in/nnamdi-dike/",
      text: "okayinyerrupt",
    },
    {
      id: 4,
      src: yy,
      link: "https://www.twitter.com/OKAYINTERRUPT",
      text: "okayinyerrupt",
    },
    {
      id: 5,
      src: vy,
      link: "mailto:emmanueldike275@gmail.com",
      text: "emmanueldike275@gmail.com",
    },
  ],
  xy = [
    "Portfolio v1",
...
var ui = Symbol.for("Animated:node"),
  ...
  ai = class extends xi {
    constructor(e) {
      super(0), (this._string = null), (this._toString = ii({ output: [e, e] }))
    }
    static create(e) {
      return new ai(e)
    }
...
var qc = class extends Error {
  ...
  _1 = class extends ma {
        ...
        actions: {
          ...
          resume: () => {
            gr(this) &&
              ...
              Tr(o.resumeQueue),
              Sr(this, "onResume", it(this, wr(this, this.animation.to)), this))
          },
    ...
    _attach() {
      let e = 0
      const { to: t } = this.animation
      Ke(t) && (ur(t, this), Zl(t) && (e = t.priority + 1)), (this.priority = e)
    }
    _detach() {
        ...
        if (R.fun(N)) {
          ...
          ;(t[v] = ({ finished: c, cancelled: p }) => {
            ...
            g
              ...
              : d.set(N, { value: null, finished: c || !1, cancelled: p || !1 })
          }),
            a && (a[v] = t[v])
        }
      })
  ...
  $1 = class extends fs {
    constructor({ x: e, y: t, z: n, ...r }) {
      ...
      ;(e || t || n) &&
        ...
        gt(r, (s, l) => {
          if (l === "transform") i.push([s || ""]), o.push((u) => [u, u === ""])
          else if (U1.test(l)) {
  ...
  rv = () =>
    k.jsxs("div", {
      ...
      children: [
        ...
        k.jsx(kt, { children: "CSS" }),
        k.jsx(kt, { children: "NODEJS" }),
      ],
    }),
  xr = ({ children: e }) =>
    ...
    function (t, n) {
      ...
      if (o) {
        ...
        if ((l = E.isFileList(t)) || r.indexOf("multipart/form-data") > -1) {
          ...
          return ys(l ? { "files[]": t } : t, u && new u(), this.formSerializer)
        }
      }
...
const Pg = yf(Cg),
  ...
  Ng = () => {
    ...
    return (
      b.useEffect(() => {
        const a = "https://api.github.com/users/emmzyrayz/repos"
        mf.get(a)
          .then((f) => {
            const h = f.data
  ...
  Rg = "https://github.com/emmzyrayz?tab=repositories"
function jg() {
